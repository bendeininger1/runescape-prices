...
This folder defines all source code for the 'latest_prices_raw' pipeline:
...
* Take a look at the sample under "sample_users_latest_prices_raw.py" to get familiar with the syntax.
